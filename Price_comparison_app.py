...
def amazon(name=""):
    ...
    for i in range(0, amazon_page_length):
        amazon_name = (
            soup.select(".a-color-base.a-text-normal")[i].getText().strip().upper()
        )
...
product_name_entry = Entry(
    window, textvariable=product_name, width=30, font=("bold", 18)
)
product_name_entry.place(relx=0.5, rely=0.1, height=30, anchor="center")

search_button = Button(
    window, text="Search", width=20, font=("bold", 20), command=search
)
