...
def ebay(name=''):
    ...
    name1 = name.replace(" ", "+")
    res = requests.get(
        f'https://www.ebay.com/sch/i.html?_from=R40&_trksid=m570.l1313&_nkw={name1}&_sacat=0', headers=headers)
...
def olx(name=""):
    ...
    name1 = name.replace(" ", "-")
    res = requests.get(
        f'https://www.olx.in/items/q-{name1}?isSearchCall=true', headers=headers)
...
product_name_entry = Entry(window, textvariable=product_name, width=30,font=("bold",18))
product_name_entry.place(relx=0.5, rely=0.1,height=30, anchor="center")

search_button = Button(window, text="Search", width=20,font=("bold", 20), command=search)
search_button.place(relx=0.5, rely=0.18,height=50, anchor="center")
changeOnHover(search_button, "grey", "white")


l1 = Label(window, text="Flipkart", font=("bold", 20), fg="green")
l2 = Label(window, text="Ebay", font=("bold", 20), fg="green")
l3 = Label(window, text="Amazon", font=("bold", 20), fg="green")
l4 = Label(window, text="Olx", font=("bold", 20), fg="green")
...
box1 = Text(window, height=10, width=50,yscrollcommand=scrollbar.set, bg="#9f9f9f", fg="black",font=("bold", 10))

box2 = Text(window, height=10, width=50, yscrollcommand=scrollbar.set,
            bg="#9f9f9f", fg="black", font=("bold", 10))

box3 = Text(window, height=10, width=50,yscrollcommand=scrollbar.set, bg="#9f9f9f", fg="black",font=("bold", 10))

box4 = Text(window, height=10, width=50, yscrollcommand=scrollbar.set,bg="#9f9f9f", fg="black", font=("bold", 10))
box1.place(relx=0.28, rely=0.4, anchor="center")
box2.place(relx=0.7, rely=0.4, anchor="center")
box3.place(relx=0.28, rely=0.7, anchor="center")
